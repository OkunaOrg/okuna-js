...
class MockRequestStrategy extends RequestStrategy {
  ...
  get(url: string, opts: object): Promise<any> {
    ...
    return new Promise((resolve) => resolve({ method: 'GET', url, headers: {
      ...contentType,
      ...opts
    } }));
  }
  ...
  post(url: string, body: object, opts: object): Promise<any> {
    const contentType = { 'Content-Type': 'application/json' };
    return new Promise((resolve) => resolve({ method: 'POST', url, body, headers: {
      ...contentType,
      ...opts
    } }));
  }
  ...
  put(url: string, body: object, opts: object): Promise<any> {
    const contentType = { 'Content-Type': 'application/json' };
    return new Promise((resolve) => resolve({ method: 'PUT', url, body, headers: {
      ...contentType,
      ...opts
    } }));
  }
  ...
  patch(url: string, body: object, opts: object): Promise<any> {
    const contentType = { 'Content-Type': 'application/json' };
    return new Promise((resolve) => resolve({ method: 'PATCH', url, body, headers: {
      ...contentType,
      ...opts
    } }));
  }
  ...
  delete(url: string, opts: object): Promise<any> {
    const contentType = { 'Content-Type': 'application/json' };
    return new Promise((resolve) => resolve({ method: 'DELETE', url, headers: {
      ...contentType,
      ...opts
    } }));
  }
  ...
  postMultiform(url: string, body: object, opts: object): Promise<any> {
    ...
    return new Promise((resolve) => resolve({ method: 'POST', formdata: true, url, body, headers: {
      ...contentType,
      ...opts
    } }));
  }
  ...
  putMultiform(url: string, body: object, opts: object): Promise<any> {
    const contentType = { 'Content-Type': 'multipart/form-data' };
    return new Promise((resolve) => resolve({ method: 'PUT', formdata: true, url, body, headers: {
      ...contentType,
      ...opts
    } }));
  }
  ...
  patchMultiform(url: string, body: object, opts: object): Promise<any> {
    const contentType = { 'Content-Type': 'multipart/form-data' };
    return new Promise((resolve) => resolve({ method: 'PATCH', formdata: true, url, body, headers: {
      ...contentType,
      ...opts
    } }));
  }
